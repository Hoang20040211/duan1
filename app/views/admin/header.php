...
<body>
  <div class="container-scroller">
    <div class="container-fluid page-body-wrapper">
      <nav style="width:285px; background-image: linear-gradient(to right, #339900, #339900);background-color: #1D2B36;padding-bottom: 400px;" class="sidebar" id="sidebar">
        <ul  class="nav">
          <li style="display: flex;gap: 20px;padding: 20px 50px;align-items: center;" class=" nav-profile">
           
              <div class="nav-profile-image">
                <img width="95px" style="margin-left: -20px;border-radius:10px" margin src="../../../public/img/log.png" alt="profile">
              </div>
          ...
          <li style="background-image: linear-gradient(to right, #339900, #339900);background-color: #1D2B36;margin-top: 5%;" class="nav-item">
          ...
          <li style="background-image: linear-gradient(to right, #339900, #339900);background-color: #1D2B36;" class="nav-item">
