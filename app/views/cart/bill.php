            ...
            <div class="row boxcontent billform">
                ...
                <table>
                    ...
                    <tr style="display:flex;gap:10px;">
                        <td><input style="border:2px solid darkgray;border-radius: 50px;width: 170px;padding: 10px;" placeholder="Tên người nhận" type="text" name="name" value="<?= $name ?>" id=""></td>


                        <td><input style="border:2px solid darkgray;border-radius: 50px;width: 170px;padding: 10px;" placeholder="Địa chỉ người nhận" type="text" name="address" value="<?= $address ?>" id=""></td>


                        <td><input style="border:2px solid darkgray;border-radius: 50px;width: 170px;padding: 10px;" placeholder="Email người nhận" type="text" name="email" value="<?= $email ?>" id=""></td>


                        <td><input style="border:2px solid darkgray;border-radius: 50px;width: 170px;padding: 10px;" placeholder="Số điện thoại người nhận" type="text" name="tel" value="<?= $tel ?>" id=""></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="row boxcontent">
                ...
                <script>
                    function displayImage() {
                        ...
                        holder.innerHTML = '<img width="350px" src="view/images/" alt="">'
                    }
                </script>
